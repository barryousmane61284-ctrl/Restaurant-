...
routefacture.get("/", roleMiddleware("admin", "caissier"), facturecontroller.getAll);
routefacture.post("/creation", roleMiddleware("admin", "caissier"), validationMiddleware(factureschema), facturecontroller.creation);
routefacture.get("/:id", roleMiddleware("admin", "caissier"), facturecontroller.getById);
routefacture.put("/:id", roleMiddleware("admin", "caissier"), facturecontroller.update);
